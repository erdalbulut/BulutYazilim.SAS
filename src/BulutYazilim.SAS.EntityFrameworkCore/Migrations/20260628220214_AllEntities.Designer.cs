...
namespace BulutYazilim.SAS.Migrations
{
    ...
    [Migration("20260628220214_AllEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulutYazilim.SAS.BankaHesaplar.BankaHesap", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Bankalar.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Faturalar.FaturaHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Hizmetler.Hizmet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Makbuzlar.Makbuz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Makbuzlar.MakbuzHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Masraflar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Ozelkodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BulutYazilim.SAS.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("BulutYazilim.SAS.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulutYazilim.SAS.Ozelkodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.Ozelkodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("BulutYazilim.SAS.Bankalar.Banka", "Banka")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Faturalar.Fatura", b =>
                {
                    b.HasOne("BulutYazilim.SAS.Cariler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BulutYazilim.SAS.Donemler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("BulutYazilim.SAS.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulutYazilim.SAS.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("BulutYazilim.SAS.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Makbuzlar.Makbuz", b =>
                {
                    b.HasOne("BulutYazilim.SAS.BankaHesaplar.BankaHesap", "BankaHesap")
                        .WithMany("Makbuzlar")
                    ...
                    b.HasOne("BulutYazilim.SAS.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("BulutYazilim.SAS.Bankalar.Banka", "CekBanka")
                        .WithMany("MakbuzHareketler")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BulutYazilim.SAS.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketler")
                    ...
                    b.HasOne("BulutYazilim.SAS.Makbuzlar.Makbuz", "Makbuz")
                        .WithMany("MakbuzHareketler")
            ...
            modelBuilder.Entity("BulutYazilim.SAS.Parametreler.FirmaParametre", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("BulutYazilim.SAS.Parametreler.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
