...
public class SASDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SASGlobalFeatureConfigurator.Configure();
        SASModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SASDomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/SAS");

            options.DefaultResourceType = typeof(SASResource);
        ...
        {
            options.MapCodeNamespace("SAS", typeof(SASResource));
        });
    }
}
